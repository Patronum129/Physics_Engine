...
public:
	...
	virtual void OnCollisionEnter(PhysicBody* col);
	virtual void OnCollisionExit(PhysicBody* col);

	virtual void OnTriggerEnter(PhysicBody* col);
	virtual void OnTriggerExit(PhysicBody* col);
