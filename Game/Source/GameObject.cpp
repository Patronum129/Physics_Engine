...
void GameObject::OnCollisionEnter(PhysicBody* col)
{

}

void GameObject::OnCollisionExit(PhysicBody* col)
{

}

void GameObject::OnTriggerEnter(PhysicBody* col)
{

}

void GameObject::OnTriggerExit(PhysicBody* col)
{
}
...
iPoint GameObject::GetScreenPosition()
{
	...
	/*pos.x = (int)(-app->render->camera->x + pos.x * app->window->scale);
	pos.y = (int)(-app->render->camera->y + pos.y * app->window->scale);*/
	return pos;
}
